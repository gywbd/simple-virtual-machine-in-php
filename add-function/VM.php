        ...
        while($opcode != HALT && $this->ip < count($this->code)) {
            ...
            switch($opcode) {
                ...
                case CALL :
                    ...
                    $this->stack[++$this->sp] = $nargs;         //save num args
                    $this->stack[++$this->sp] = $this->fp;      //save fp
                    $this->stack[++$this->sp] = $this->ip;      //push return address

                    $this->fp = $this->sp;                      //fp points at ret addr on stack
                    $this->ip = $addr;                    //jump to function

                    //code premable of func must push space for locals
                    break;
                case RET :
